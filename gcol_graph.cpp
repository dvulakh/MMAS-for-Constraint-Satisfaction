...
// Return cost of adding new vertex to path (number of new adjacent equally-colored vertices)
...
/*** IMPLEMENTATIONS ***/
gcol_graph_map::gcol_graph_map(int nvar, int max_val, int plen, string conf) : construction_graph_map(nvar, max_val, plen) { gcol_init(conf); this->relative = true; this->circular = false; }
